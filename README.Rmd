...
The goal of CIGAP is to detect the molecular pathways associated with the expression levels of 
    the target circRNAs.

## Installation

You can install the development version from [GitHub](https://github.com/ABuratin/CIGAP) with:
