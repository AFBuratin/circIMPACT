...
library(tidyr)
=======
>>>>>>> bed5955bdae18eba2b30d7462e76e060bbade99b
```
----
...
var$contrib
g3 <- fviz_contrib(pca, choice="var", axes = 1:2, top = 25)

table_circRNArank = g3$data[order(g3$data$contrib, decreasing = T),]
...
```{r}
top20 = ordered(var$contrib[,1])[1:25]

fviz_pca_biplot(pca, #select.ind = list(contrib = 5), 
               ...
               repel = TRUE,
                ...
                legend.title = list(fill = "Condition", color = "Contrib",
                                    alpha = "Contrib")) +
  labs(subtitle = "Top 20 variables with highest contribution of the event to PC1 and PC2",
       caption = "") +
  theme(axis.text.x = element_text(size=18), 
        axis.text.y = element_text(size=18), 
        axis.title = element_text(size=20), 
...
my_data = data.frame(circHIPK3 = as.vector(t(circNormDeseq["11:33286412-33287511",-7])), 
                     QKI = filt.mat["QKI",])
ggscatter(my_data, x = "circHIPK3", y = "QKI", 
